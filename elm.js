			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('window.inner Size: meta viewport width=device-width')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Width: ' + ($elm$core$String$fromInt(model.width) + ('px, Height: ' + ($elm$core$String$fromInt(model.height) + 'px'))))
							]))
					]))
			]));
};
